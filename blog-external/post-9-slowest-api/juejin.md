...
延伸阅读（[paretojs.tech](https://paretojs.tech)）：

- [不用 Server Components 也能做 React 流式 SSR](https://paretojs.tech/zh/blog/streaming-ssr/) —— 完整代码的实战指南
- [SSR 性能基准测试](https://paretojs.tech/zh/blog/benchmarks/) —— Pareto vs Next.js、React Router、TanStack Start 的压力测试
- [head.tsx 就是一个 React 组件](https://paretojs.tech/zh/blog/head-tsx-seo/) —— 用 loader 数据生成动态 SEO meta
