...
This post walks through every routing pattern Pareto supports, with examples you can copy directly into your `app/` folder.
...
- [Routing docs](/concepts/routing/) — reference for every convention file
- [Streaming SSR](/blog/streaming-ssr/) — how `defer()` and `<Await>` work inside any route
- [Head management](/concepts/head-management/) — per-route titles and meta tags
