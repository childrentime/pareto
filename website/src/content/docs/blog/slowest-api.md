...
<p class="blog-meta">By <a href="https://github.com/childrentime">childrentime</a> · April 27, 2026</p>
...
Related reading:
- [React Streaming SSR Without Server Components](/blog/streaming-ssr/) — the practical how-to with full code
- [SSR Benchmarks: How We Compare](/blog/benchmarks/) — Pareto vs Next.js, React Router, TanStack Start under load
- [head.tsx Is Just a React Component](/blog/head-tsx-seo/) — dynamic SEO meta from loader data
