...
- [Routing docs](/concepts/routing/) — dynamic routes, catch-all routes, nested layouts
- [Streaming SSR docs](/concepts/streaming/) — when to use defer(), error handling
- [State management docs](/concepts/state-management/) — defineStore, defineContextStore
- [Benchmarks](/blog/benchmarks/) — Pareto vs Next.js vs React Router performance data
