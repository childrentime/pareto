---
title: "5 分钟用 Vite SSR 搭建一个全栈 React 应用"
description: 从零到流式 React SSR 应用——文件路由、loader、状态管理、生产部署，全部在 5 分钟内完成。
template: splash
---
...
- [路由文档](/zh/concepts/routing/) — 动态路由、catch-all 路由、嵌套布局
- [流式 SSR 文档](/zh/concepts/streaming/) — 何时使用 defer()、错误处理
- [状态管理文档](/zh/concepts/state-management/) — defineStore、defineContextStore
- [基准测试](/zh/blog/benchmarks/) — Pareto vs Next.js vs React Router 性能数据
